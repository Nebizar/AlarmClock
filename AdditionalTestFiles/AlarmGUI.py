...
def getAlarms():
    ...
    output = ""
    #print(activated_alarm)
    #print(type(activated_alarm))
    for alarm in alarms:
        #print(alarm[0])
        #print(type(alarm[0]))
        if alarm[0] == activated_alarm:
            print("ELOELOELOELEOELOELOL")
            output = output + str(alarm[0]) + "|" + str(alarm[2]) + ":" + str(alarm[3]) + "|1;"
        else:
